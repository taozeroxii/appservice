    ...
    <div class="uk-container uk-padding">
        ...
        <form id="demo1" class="demo" style="display:none;" autocomplete="off" uk-grid >
            ...
            <div class="uk-width-1-2@m">
                ...
                <input name="fname" class="uk-input uk-width-1-1" type="text">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">นามสกุล</label>
                <input name="lname" class="uk-input uk-width-1-1" type="text">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">เบอร์โทรศัพท์</label>
                <input name="phone" class="uk-input uk-width-1-1" type="text">
            </div>
            <div class="uk-width-1-2@m">
            ...
            <div class="uk-width-1-2@m">
                ...
                <input name="adddess" class="uk-input uk-width-1-1" type="text">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">หมู่</label>
                <input name="moo" class="uk-input uk-width-1-1" type="text">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">ตำบล / แขวง</label>
                <input name="district" class="uk-input uk-width-1-1" type="text" value="25130">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">อำเภอ / เขต</label>
                <input name="amphoe" class="uk-input uk-width-1-1" type="text" value="25130">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">จังหวัด</label>
                <input name="province" class="uk-input uk-width-1-1" type="text" value="25130">
            </div>
            <div class="uk-width-1-2@m">
                <label class="h2">รหัสไปรษณีย์</label>
                <input name="zipcode" class="uk-input uk-width-1-1" type="text" value="25130">
            </div>
            <div class="uk-width-1-2@m">
             <button class="button" style="vertical-align:middle"><span>ยืนยันข้อมูล </span></button>
         </div>
     </form>
 </div>
